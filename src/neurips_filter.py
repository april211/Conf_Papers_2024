...
def load_data():
    data = pd.read_csv("data/NeurIPS_2024_Events.csv", 
...
if __name__ == "__main__":
    ...
    cnt = 0
    with open("res/raw/neurips_results.md", "w") as f:
        for row in data.itertuples():
            ...
            #         print("***")
            # debug
            if "graph homophily" in row.text:
                print("pos_score: ", pos_score, ", neg_score: ", neg_score, ", aug_score: ", aug_score)
                print("pos_lst: ", pos_lst)
                print("neg_lst: ", neg_lst)
                print("neg_keywords: ", neg_keywords[neg_lst.index(True)])
                print("aug_lst: ", aug_lst)
                print("***")
